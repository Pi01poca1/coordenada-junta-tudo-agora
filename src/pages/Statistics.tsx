  ...
  const fetchStats = async () => {
    ...
    try {
      ...
      const weeklyActivity = last7Days.map((date) => {
        ...
        const dayWords = dayChapters.reduce(
      ...
      const mostProductiveDay =
        weeklyActivity.reduce(
          (most, current) => (current.words > most.words ? current : most),
          weeklyActivity[0]
        )?.date || ''
        ...
        <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="mt-2 text-xs text-muted-foreground">Capítulos criados</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="mt-2 text-xs text-muted-foreground">Palavras escritas</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="mt-2 text-xs text-muted-foreground">Assistência utilizada</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <div className="text-2xl font-bold">{stats.averageChaptersPerBook}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div>
                <div className="text-xl font-bold">{stats.mostProductiveDay || 'N/A'}</div>
