  ...
  return (
    <Card className="w-full">
      ...
      <CardContent className="space-y-4">
        ...
        <Button onClick={uploadCover} disabled={!selectedFile || uploading} className="w-full">
        ...
        {selectedFile && previewUrl && (
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-gradient-to-br from-slate-50 to-slate-100 p-6 dark:from-slate-900 dark:to-slate-800">
              <div className="flex flex-col gap-6 md:flex-row">
                {/* Preview da imagem */}
                <div className="flex-shrink-0">
                  <div className="mx-auto aspect-[2/3] w-32 overflow-hidden rounded-lg border-2 border-slate-200 bg-white shadow-lg md:mx-0">
                    <img
                      src={previewUrl}
                      alt="Preview da capa"
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <div
                        className={`h-2 w-2 rounded-full ${selectedFile.size > 5 * 1024 * 1024 ? 'bg-green-500' : 'bg-yellow-500'}`}
                      ></div>
