...
export const ImageGallery = ({
  ...
  const fetchImages = async () => {
    ...
    try {
      ...
      console.log(
        '🔍 ImageGallery: Query completed. Data:',
        data?.length || 0,
        'images, Error:',
        error
      )
    ...
    return (
      <Card>
        <CardContent className="pt-6">
          <div className="text-center text-muted-foreground">Carregando galeria de imagens...</div>
        </CardContent>
      </Card>
    )
  }
            ...
            {filteredImages.map((image) => (
              <div
                ...
                className={`group relative overflow-hidden rounded-lg border ${
                  selectable && selectedImageId === image.id ? 'ring-2 ring-primary' : ''
              ...
              >
                ...
                <div className="bg-background p-2">
                  ...
                  {image.alt_text && (
                    <p className="truncate text-xs text-muted-foreground" title={image.alt_text}>
                      {image.alt_text}
                    </p>
                  )}
                </div>
