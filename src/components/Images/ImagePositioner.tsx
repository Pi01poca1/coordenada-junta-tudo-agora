      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="outline">Arraste a imagem para posicionar</Badge>
          </div>

          <div
            ref={containerRef}
            className="relative min-h-[400px] overflow-hidden rounded-lg border bg-gray-50 p-4"
          ...
          >
            ...
            <img
              ...
              src={image.url}
              alt={image.filename}
              className={`absolute cursor-move rounded border-2 border-blue-500 shadow-lg ${isDragging ? 'border-blue-700 shadow-xl' : ''}`}
              style={{
                left: position.x,
                top: position.y,
