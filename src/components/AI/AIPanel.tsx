        ...
        <Tabs defaultValue="enrich" className="w-full">
          ...
          <TabsContent value="enrich" className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <Select
                value={selectedGoal}
                onValueChange={(value: AIGoal) => setSelectedGoal(value)}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
          ...
          <TabsContent value="prompt" className="space-y-4">
            ...
            {promptResult && (
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div className="rounded bg-muted p-3 text-sm">{promptResult.prompt}</div>
                  <Button
                    size="sm"
                    variant="outline"
          ...
          <TabsContent value="history" className="space-y-4">
            ...
            <ScrollArea className="h-64 w-full">
              <div className="space-y-2">
                {history.length === 0 ? (
                  <div className="flex items-center gap-2 p-4 text-center text-sm text-muted-foreground">
                  ...
                  history.map((item, index) => (
                    <Card key={index} className="p-3">
                      ...
                      <div className="text-sm">
                        <div className="mb-1 font-medium">{item.input_prompt}</div>
                        {item.output_content && (
